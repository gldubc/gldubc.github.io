...
checkout =
  System.get_env("ELIXIR_CHECKOUT") ||
    raise """
    ELIXIR_CHECKOUT is required.

    Point it at an Elixir checkout, for example:

      export ELIXIR_CHECKOUT=/path/to/elixir-checkout
    """

Code.require_file(Path.join([checkout, "lib/elixir/test/elixir/module/types/type_helper.exs"]))
